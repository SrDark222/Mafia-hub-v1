...
local redzlib = {
	Themes = {
		Darker = { -- Azul com preto (normal)
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(5, 5, 15)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(10, 10, 20),
			["Color Stroke"] = Color3.fromRGB(0, 60, 255),
			["Color Theme"] = Color3.fromRGB(0, 90, 255),
			["Color Text"] = Color3.fromRGB(240, 240, 240),
			["Color Dark Text"] = Color3.fromRGB(150, 150, 150)
		},

		Dark = { -- Preto com vermelho 🔥
			["Color Hub 1"] = ColorSequence.new({
			...
			["Color Theme"] = Color3.fromRGB(255, 25, 25),
			["Color Text"] = Color3.fromRGB(250, 250, 250),
			["Color Dark Text"] = Color3.fromRGB(170, 50, 50)
		},

		Purple = { -- Preto e roxo 🕶️💜
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 0, 25)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 0, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 0, 25))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 0, 30),
			["Color Stroke"] = Color3.fromRGB(90, 0, 150),
			["Color Theme"] = Color3.fromRGB(160, 0, 255),
			["Color Text"] = Color3.fromRGB(245, 245, 245),
			["Color Dark Text"] = Color3.fromRGB(180, 100, 200)
		}
	}
	},
	Info = {
